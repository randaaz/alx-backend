...
a dataset of popular baby names with additional functionality
for indexed dataset pagination.
"""
...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """ Get a page from the dataset using an index
        with hypermedia pagination info. """
